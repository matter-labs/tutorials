# Building a custom paymaster with API3 data feeds 
...
<!--Vansh is there anything we need to add?-->
...
Within a paymaster price oracles can be used to provide price data on-chain for execution. Within this paymaster tutorial you will implement a dAPI for this reason.
